...
\begin{enumerate}
	...
	\item In the presence of integer variables, PH is a heuristic, as the alternating strategy loses its convergence guarantees. This can be addressed with a variant of the method \citep{BOLAND2018, BOLAND2019}, but it only makes it a bounding strategy due to the possible presence of duality gaps. \citet{KIM2022} describe how PH can be incorporated within a branch-and-bound algorithm for addressing eventual duality gaps.
\end{enumerate}
